...
class ConfigurationTable: UITableViewController
{
    ...
    var travelType : TravelType = .Timer
    var steps = 10
    var seconds = 10
    ...
    {
        super.viewDidLoad()
        self.tableView.register(UINib(nibName: "ConfigCell", bundle: nil), forCellReuseIdentifier: "ConfigCell")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if indexPath.row == 0
        {
            ...
            cell.lblDescription.text = "Travel by"
            cell.switch.isHidden = false
            cell.txtValue.text = "\(10)"
